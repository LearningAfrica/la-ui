...
export function CourseReviewForm({ courseId, courseName }: CourseReviewFormProps) {
  ...
  const onSubmit = async (values: ReviewFormValues) => {
    ...
    try {
      ...
      toast({
        title: values.decision === "approve" ? "Course approved" : "Changes requested",
        description:
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Provide feedback to the instructor about their course submission</CardDescription>
      </CardHeader>
      <CardContent>
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            ...
            {watchDecision === "reject" && (
              <div className="space-y-4">
                <div className="text-sm font-medium">Reason for changes (select all that apply):</div>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Be specific and constructive in your feedback to help the instructor improve their course.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
