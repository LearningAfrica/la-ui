...
export function MegaMenu() {
  ...
  return (
    <div className="relative">
      ...
      >
        Courses <ChevronDown className={`h-4 w-4 transition-transform ${isOpen ? "rotate-180" : ""}`} />
      </Button>

      {isOpen && (
        <Card className="absolute left-0 top-full z-50 mt-2 w-[600px] grid grid-cols-3 gap-4 p-4">
