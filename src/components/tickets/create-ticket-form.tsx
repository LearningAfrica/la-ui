				...
				<FormField
					...
					render={({ field }) => (
						<FormItem>
							...
							<FormDescription>
								Include steps to reproduce, error messages, and any other
								relevant details.
							</FormDescription>
							<FormMessage />
						</FormItem>
				...
				<div className="space-y-4">
					<div>
						...
						<div className="mt-1 flex items-center gap-4">
							<label
								htmlFor="file-upload"
								className="border-input bg-background ring-offset-background hover:bg-accent hover:text-accent-foreground flex h-10 cursor-pointer items-center gap-2 rounded-md border px-3 py-2 text-sm file:border-0 file:bg-transparent file:text-sm file:font-medium"
							>
							...
							<p className="text-muted-foreground text-xs">
								Max 5MB per file. Images, PDFs, and documents.
							</p>
						</div>
					</div>
