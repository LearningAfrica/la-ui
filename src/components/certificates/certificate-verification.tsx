		...
		<Card>
			...
			<CardContent className="space-y-4">
				<div className="flex items-center justify-between">
					<div className="text-muted-foreground text-sm">Credential ID</div>
					<div className="flex items-center">
						<span className="mr-2 text-sm font-medium">{credentialId}</span>
						<Button
							variant="ghost"
							size="icon"
							className="h-6 w-6"
				...
				<div className="flex flex-col space-y-2">
					...
					<div className="bg-muted flex items-center justify-between rounded-md p-2 text-sm">
						<span className="mr-2 truncate">{verificationUrl}</span>
