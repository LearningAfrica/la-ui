  ...
  return (
    <>
      <Card>
        ...
        <CardFooter>
          <Button variant="outline" size="sm" className="w-full" onClick={() => setIsNotificationsPanelOpen(true)}>
            View all notifications
          </Button>
        </CardFooter>
      </Card>

      <NotificationsPanel open={isNotificationsPanelOpen} onOpenChange={setIsNotificationsPanelOpen} />
    </>
  )
}
