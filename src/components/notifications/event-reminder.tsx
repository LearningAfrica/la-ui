...
export function EventReminder({ id, title, date, type, course, color, onDismiss, onSnooze }: EventReminderProps) {
      ...
      <CardContent className="p-4">
        <div className="flex justify-between items-start">
          ...
          <div className="flex gap-1">
            <Button variant="ghost" size="icon" className="h-8 w-8" onClick={() => onDismiss(id)}>
              <X className="h-4 w-4" />
