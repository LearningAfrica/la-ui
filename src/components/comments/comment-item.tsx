...
import { ThumbsUp, MessageSquare, MoreHorizontal, Flag, Trash, Edit } from "lucide-react"
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
      ...
      <div className="flex gap-4">
        ...
        <div className="flex-1 space-y-2">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              {author.role === "instructor" && (
                <span className="rounded-full bg-primary/10 px-2 py-0.5 text-xs text-primary">Instructor</span>
              )}
          ...
          {showReplies && hasReplies && (
            <div className="mt-4 space-y-4 pl-6 pt-2">
              {replies.map((reply) => (
                <CommentItem
                  key={reply.id}
                  {...reply}
