    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[600px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Share "{event?.title}" with other students or groups
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4">
                ...
                {filteredStudents.length > 0 ? (
                  <div className="space-y-2">
                    {filteredStudents.map((student) => (
                      <div
                        key={student.id}
                        className="hover:bg-muted/50 flex cursor-pointer items-center justify-between rounded-md border p-2"
                        ...
                        <div className="flex items-center gap-3">
                          <div className="flex -space-x-2">
                            {group.members.slice(0, 3).map((memberId) => {
                              const member = sampleStudents.find(
                                (s) => s.id === memberId,
                              );
                              return (
                                <Avatar
                            ...
                            {group.members.length > 3 && (
                              <div className="border-background bg-muted flex h-7 w-7 items-center justify-center rounded-full border-2 text-xs">
                                +{group.members.length - 3}
                              </div>
                            )}
                          </div>
          ...
          {(selectedStudents.length > 0 || selectedGroups.length > 0) && (
            <div className="border-t pt-2">
              <h4 className="mb-2 text-sm font-medium">Selected Recipients</h4>
          ...
          >
            <div className="grid gap-2">
              ...
              <Input
                id="message"
                placeholder="Enter a message to send with this event"
            ...
            <div className="flex items-center space-x-2">
              <Checkbox
                ...
                onCheckedChange={(checked) =>
                  form.setValue('allowEdit', !!checked)
                }
              />
              <label
                htmlFor="allowEdit"
            ...
            <div className="flex items-center space-x-2">
              <Checkbox
                ...
                onCheckedChange={(checked) =>
                  form.setValue('notifyRecipients', !!checked)
                }
              />
              <label
